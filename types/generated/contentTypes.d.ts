...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    FoundersVoiceSection: Schema.Attribute.Component<
      'shared.founders-voice-section',
      false
    >;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    OurMission: Schema.Attribute.Component<'shared.our-mission', false>;
    OurStory: Schema.Attribute.Component<'shared.our-story', false>;
    OurValues: Schema.Attribute.Component<'shared.our-values', false>;
    PeakHealthCards: Schema.Attribute.Component<'shared.peak-health', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    FoundersVoiceSection: Schema.Attribute.Component<
      ...
      false
    >;
    HealthcareEcosystemSection: Schema.Attribute.Component<
      'shared.healthcare-ecosystem-company',
      false
    >;
    HeroSection: Schema.Attribute.Component<'shared.hero-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    NewsletterSection: Schema.Attribute.Component<
      ...
      false
    >;
    PressReleasesSection: Schema.Attribute.Component<
      'shared.press-releases-section',
      false
    >;
    ProvenResultsSection: Schema.Attribute.Component<
      'shared.proven-results-section',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhatWeDoSection: Schema.Attribute.Component<'shared.what-we-do', false>;
  };
}
...
export interface ApiPressReleasePressRelease
  ...
  attributes: {
    ...
    FullText: Schema.Attribute.Text;
...
export interface ApiProductAndServiceProductAndService
  ...
  info: {
    ...
    pluralName: 'product-and-services';
    singularName: 'product-and-service';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    OurProducts: Schema.Attribute.Component<'shared.our-products', true>;
    PatentedFitnessProducts: Schema.Attribute.Component<
      'shared.patented-fitness-products',
      false
    >;
    PrimaryCareSystems: Schema.Attribute.Component<
      'shared.primary-care-systems',
      false
    >;
    publishedAt: Schema.Attribute.DateTime;
    QuitSmokingSolutions: Schema.Attribute.Component<
      'shared.quit-smoking-solutions',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WellMDDifference: Schema.Attribute.Component<
      'shared.well-md-difference',
      false
    >;
  };
}
